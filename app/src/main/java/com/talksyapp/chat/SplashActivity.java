...
public class SplashActivity extends AppCompatActivity {
    ...
    private void routeUser() {
        ...
        boolean isLoggedInAndVerified = user != null && user.isEmailVerified();
        Intent intent = new Intent(this, isLoggedInAndVerified ? HomeActivity.class : LoginActivity.class);
