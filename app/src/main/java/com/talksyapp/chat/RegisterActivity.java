...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void validateAndRegister() {
        ...
        setLoading(true);
        authRepository.checkUsernameTaken(username, new AuthRepository.UsernameCallback() {
            @Override
            public void onResult(boolean isTaken) {
                if (isTaken) {
                    setLoading(false);
                    Toast.makeText(RegisterActivity.this, R.string.error_username_taken, Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void goToHome() {
        setLoading(false);
        Toast.makeText(this, "Welcome to TalksyApp!", Toast.LENGTH_SHORT).show();
